...
const News = () => {
  return (
    <div className="py-16">
      ...
      <div className="hidden lg:grid grid-cols-1 md:grid-cols-2 gap-12">
        {news.map((item, index) => (
          <div key={index} className="flex flex-col sm:flex-row sm:justify-between items-center gap-12 bg-white p-6 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            <div className="py-4">
              <Link to="/">
                <h3 className="text-lg font-medium hover:text-blue-500 mb-4">
                  {item.title}
